...
// GET/POST mirip aksesAutoUpdateAllJuz.js tetapi file: autoUpdateAllJuzMur.json
...
export async function onRequest({ request, env }) {
  ...
  if (request.method === "GET") {
    ...
    return new Response(r.data ? JSON.stringify(r.data) : "[]", {
  ...
  if (request.method === "POST") {
    ...
    const put = await putJson(FILE_PATH, arr, token, cur.sha || null, `autoUpdateAllJuzMur: upsert kelas=${kelas}`, { minify: false });
